...
$base_url =
	...
	$upload_dir = '/img/blogImages/'; // path from base_url to base of upload folder (with start and final /)
	$current_path = '../img/blogImages/'; // relative path from filemanager folder to upload folder (with final /)
	//thumbs folder can't put inside upload folder
	$thumbs_base_path = '../img/blogThumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
